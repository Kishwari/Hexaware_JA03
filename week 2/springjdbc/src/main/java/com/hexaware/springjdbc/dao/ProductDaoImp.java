...
public class ProductDaoImp implements IProductDao {
	...
	public boolean createProduct(Product product) {
		...
		String insertQuery = "insert into Products(pid,productName,price) values(?,?,?)";
	...
	public boolean updateProduct(Product product) {
		...
		String updateQuery = "update products set productName = ? , price = ?  where pid = ?";
	...
	public Product selectProductById(int productId) {
		...
		String selectQueryById = "select pid,productName,price from products where pid = ?";
	...
	public List<Product> selectAllProducts() {
		...
		String selectQuery = "select pid,productName,price from products";
